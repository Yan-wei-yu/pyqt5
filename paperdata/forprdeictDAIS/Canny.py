...
# 讀取兩張圖片
image1 = cv2.imread('./r=2threepicture/data0403.png', cv2.IMREAD_GRAYSCALE)
image2 = cv2.imread('../Differentdepth_answer/r=2/data0403.png', cv2.IMREAD_GRAYSCALE)
...
# 儲存結果
cv2.imwrite('./edgecanny/edges1_ai_100000_data0403.png', edges1)
cv2.imwrite('./edgecanny/edges2_an.png', edges2)
cv2.imwrite('./cannygap/difference_100000_data0403.png', difference)
cv2.imwrite('./cannygap/differencecolor_100000_data0403.png', colored_diff)

...
# mask = cv2.imread('./mask.png', 0)  # 二值遮罩圖，中間缺損為255，其餘為0
...
# cv2.imwrite('./end.png', depth_result)
...
# 讀入灰階遮罩
mask_gray = cv2.imread("./mask.png", cv2.IMREAD_GRAYSCALE)
...
# 儲存結果
cv2.imwrite("./poisson_blended.png", output)
